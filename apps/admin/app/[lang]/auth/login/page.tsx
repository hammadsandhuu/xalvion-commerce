            ...
            <div className="basis-full xl:basis-1/2 hidden xl:block relative w-[500px]">
              ...
              <div className="bg-primary h-full w-full rounded-3xl rounded-tr-none xl:p-[60px] ltr:xl:pr-9 rtl:xl:pl-9 relative overflow-hidden">
                ...
                <div className="text-xl mt-2 text-primary-foreground flex gap-1">
                  <span>
                    <BarChart3 className="text-primary-foreground text-2xl" />
                  </span>
                  Welcome to your administration panel. Monitor system
                  performance and manage your platform efficiently.
                </div>
                ...
                <div className="bg-card overflow-hidden w-full rounded-3xl rounded-tr-none relative mt-11 pt-8 pb-7 pl-4">
                  ...
                  <div className="w-[90%] mx-auto">
                    <div className="ltr:pl-4 rtl:pr-8 pb-4">
                      ...
                      <div className="space-y-4 mt-10">
                        <div className="text-default-700 text-lg leading-relaxed">
                          <p className="mb-2">
                            You are accessing the administrative control panel.
                            This area contains sensitive system configuration
                            and user management tools.
                          </p>
                          <p className="mb-2">
                            Ensure you follow security best practices and log
                            out when your session is complete.
                          </p>
                        </div>
                      </div>
                    </div>
